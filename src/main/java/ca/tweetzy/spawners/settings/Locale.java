...
public final class Locale {
	...
	public static void setup() {
		...
		for (File file : files) {
			...
			final TweetzyYamlConfig yamlFile = new TweetzyYamlConfig(Spawners.getInstance(), "/locales/" + file.getName());
	...
	private static void setupDefaults(String name) {
		final TweetzyYamlConfig yamlFile = new TweetzyYamlConfig(Spawners.getInstance(), "/locales/" + name + ".yml");
	...
	private static File[] getFiles(@NonNull String directory, @NonNull String extension) {
		...
		final File dataFolder = new File(Spawners.getInstance().getDataFolder(), directory);
