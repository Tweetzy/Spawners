...
public final class Locale {
	...
	public static void setup() {
		...
		for (File file : files) {
			...
			final YamlFile yamlFile = new YamlFile(Spawners.getInstance().getDataFolder() + "/locales/" + file.getName());
	...
	private static void setupDefaults(String name) {
		final YamlFile yamlFile = new YamlFile(Spawners.getInstance().getDataFolder() + "/locales/" + name + ".yml");
		yamlFile.createOrLoadWithComments();
		yamlFile.setCommentFormat(YamlCommentFormat.PRETTY);
