...
public abstract class SpawnersPagedGUI<T> extends PagedGUI<T> {

	public SpawnersPagedGUI(Gui parent, @NonNull String title, int rows, @NonNull List<T> items) {
		super(parent, title, rows, items);

	}

	public SpawnersPagedGUI(@NonNull String title, int rows, @NonNull List<T> items) {
